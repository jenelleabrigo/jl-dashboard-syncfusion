...
const Cart = () => {
  ...
  return (
    <div className="bg-half-transparent w-full fixed nav-item top-0 right-0 ">
      <div className="float-right h-screen overflow-auto duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white w-72 md:w-400 p-8">
        ...
        {cartData?.map((item, index) => (
          <div key={index}>
            <div>
              <div className="md:flex items-center leading-8 gap-5 border-b-1 border-color dark:border-gray-600 p-4">
